...
void getUserInput(int &month, char &delimiter1, int &day, char &delimiter2, int &year);
...
int main() {
    ...
    do {
        ...
        getUserInput( month, delimiter1,  day, delimiter2,  year );
...
/* This function gets the user input and stores them back into the main variables via
 * pass by reference
 *
...
/*
 ...
 Mike-2:Desktop michaelgonzalez$ ./a.out
